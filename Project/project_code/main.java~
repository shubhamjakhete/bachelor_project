...
public class main extends JFrame implements ActionListener
{
	...
	public main(String title)
	{
		...
		//Add Insert Button
		btnNew = new JButton("Insert");
		btnNew.setForeground(Color.black);
		btnNew.setBounds(10,10,100,50);
		...
		btnView.setBounds(100,10,100,50);
		...
		btnDelete.setBounds(200,10,100,50);
		...
		btnUpdate.setBounds(300,10,100,50);
		...
		btnSearch.setBounds(400,10,100,50);
		...
		btnDate.setBounds(500,10,100,50);
		...
		btnExit.setBounds(600,10,100,50);
